          ...
          {companions.map(({ id, subject, name, topic, duration }) => (
              <TableRow key={id}>
                ...
                <TableCell>
                  ...
                  <div className="flex items-center justify-center rounded-lg w-fit p-2 md:hidden" style={{backgroundColor:getSubjectColor((subject))}}><Image src={`/Icons/${subject}.svg`} alt="subject" width={18} height={18} /></div>
                </TableCell>
